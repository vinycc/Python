class CarroCorrida:
    ...
    def acelerar(self, velocidade):
        if self.__ligado is True:
            ...
            # se ultrapassar velocidade máxima, mantém a máxima
...
carro.acelerar(20)
print(carro.get_velocidade_atual())         # 0 (o carro está desligado)
carro.ligar()
carro.acelerar(20)
print(carro.get_velocidade_atual())         # 20
carro.acelerar(80)
print(carro.get_velocidade_atual())         # 100
carro.acelerar(70)
print(carro.get_velocidade_atual())         # 150 (não ultrapassa a vel. max.)
carro.frear()
print(carro.get_velocidade_atual())         # 0 (o carro está parado)
